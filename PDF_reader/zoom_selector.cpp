    ...
    : QComboBox(parent)
{
    ...
    connect(this, &QComboBox::currentTextChanged,this, &zoom_selector::on_zoom_text_changed);
    connect(lineEdit(), &QLineEdit::editingFinished,this, [this](){on_zoom_text_changed(lineEdit()->text()); });
